...
class PassengerOutput(BaseModel): # jab bhi child class ky round bracket main kisi dusri class ka name ho wo concept inheritance khlata hai or Class ky name ka phla word hmesha bara aye ga yani Capital 
    ...
    # Answer PassengerOutput(response='Your luggage is within the weight limit. Have a pleasant flight!', isWeightExceed=False)        
...
async def run_main():
    try:  # means janey do / chlny do
        ...
        print("Passenger is onbaord") # agartripwire_triggered=False hui tw ye chly ga 

    except InputGuardrailTripwireTriggered: # agar tripwire_triggered=True hui tw ye class chly ga
